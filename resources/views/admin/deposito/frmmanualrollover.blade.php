...
<div class="content-wrapper" style="margin-top:10px; max-height:800px !important;">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="dropdown-menu">
                      <a href="#" tabindex="-1" class="dropdown-item" data-toggle="modal" data-target="#modal-update-rollover"
  ...
  <div class="modal fade" id="modal-update-rollover">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
      <form action="/bo_dp_de_manrollover" id="formeditdeposito" method="POST" enctype="multipart/form-data" onmouseover="myTime();">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Perpanjangan Manual Deposito</h4>
