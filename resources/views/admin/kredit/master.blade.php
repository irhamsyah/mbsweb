  ...
  <div class="form-group row">
    <div class="col-lg-4">
      <div class="row">
        ...
        <div class="col-lg-6 col-sm-12">
          ...
          <input type="text" name="inputtglpklama" class="form-control" value="{{$tgllogin}}">
        </div>
        <div class="col-lg-6 col-sm-8">
          <label for="inputreviewbunga">Review Bunga</label>
          <div class="input-group mb-2 autocomplete">
            <input type="text" name="inputreviewbunga" class="form-control" value="0">
        ...
        <div class="col-lg-12 col-sm-12">
          ...
          <div class="form-check">
            ...
            <input class="form-check-input" type="radio" name="inputstatus" <?php //if($kredit->STATUS_AKTIF=="3"){echo
            'checked';?>>
    ...
    <div class="col-lg-4">
      <div class="row">
        ...
        <div class="col-lg-12 col-sm-12">
          <div class="input-group mb-2 autocomplete">
            <input id="inputNasabahIdadd" type="text" class="form-control" name="inputnasabahid" required>
            <div class="input-group-prepend">
        ...
        <div class="col-lg-12 col-sm-12">
          ...
          <input id="inputNamaNasabahadd" type="text" name="inputnasabahnama" readonly class="form-control">
        </div>
        <div class="col-lg-12 col-sm-12">
          <label for="inputnasabahalamat">Alamat</label>
          <input id="inputalamatadd" type="text" name="inputnasabahalamat" readonly class="form-control">
        </div>
        <div class="col-lg-12 col-sm-12">
        ...
        <div class="col-lg-6 col-sm-12">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="inputreschedule" <?php echo 'checked' ;?>>
        ...
        <div class="col-lg-6 col-sm-12">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="inputwo" <?php // if($kredit->STATUS_AKTIF=="1"){echo
            'checked';?>>
      ...
      <div class="row">
        <div class="col-lg-12 col-sm-12">
          ...
          <select class="form-control" name="inputkodegorup1">
            ...
            <option value="{{ $kodegroup1kredit->KODE_GROUP1 }}">{{ $kodegroup1kredit->KODE_GROUP1.' -
              '.$kodegroup1kredit->DESKRIPSI_GROUP1 }}</option>
            @endforeach
          </select>
        </div>
        <div class="col-lg-12 col-sm-12">
          ...
          <select class="form-control" name="inputkodegorup2">
            ...
            <option value="{{ $kodegroup2kredit->KODE_GROUP2 }}">{{ $kodegroup2kredit->KODE_GROUP2.' -
              '.$kodegroup2kredit->DESKRIPSI_GROUP2 }}</option>
            @endforeach
          </select>
        </div>
        <div class="col-lg-12 col-sm-12">
          ...
          <select class="form-control" name="inputkodegorup3">
            ...
            <option value="{{ $kodegroup3kredit->KODE_GROUP3 }}">{{ $kodegroup3kredit->KODE_GROUP3.' -
              '.$kodegroup3kredit->DESKRIPSI_GROUP3 }}</option>
            @endforeach
          </select>
        </div>
        <div class="col-lg-12 col-sm-12">
        ...
        <div class="col-lg-12 col-sm-12">
          ...
          <select class="form-control" name="inputsumberdana" required>
            ...
            <option value="{{ $kodesumberdanakredit->KODE_SUMBER_DANA }}">{{ $kodesumberdanakredit->KODE_SUMBER_DANA.' -
              '.$kodesumberdanakredit->DESKRIPSI_SUMBER_DANA }}</option>
            @endforeach
          </select>
        </div>
        <div class="col-lg-12 col-sm-12">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-sm-12">
          ...
          <select class="form-control" name="inputsatuanwaktuangsuran" onchange="hitungjmlangsuran()">
            ...
            <option value="{{ $kodesatuanwaktuangsuran->KODE_SATUAN_WAKTU }}">{{
              $kodesatuanwaktuangsuran->KODE_SATUAN_WAKTU.' - '.$kodesatuanwaktuangsuran->DESKRIPSI_SATUAN_WAKTU }}
            </option>
            @endforeach
          </select>
        </div>
    ...
    <div class="col-lg-4">
      <div class="row">
        ...
        <div class="col-lg-3 col-sm-12">
          ...
          <div class="form-check">
            ...
            <input class="form-check-input" type="checkbox" value="1" name="inputamortisasiprovisi" <?php
              //if($kredit->AMORTISASI_PROVISI=="1"){echo 'checked';}?>>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-sm-12">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="inputamortisasiadm" <?php
              //if($kredit->amortisasi_adm=="1"){echo 'checked';}?>>
            <label class="form-check-label" style="margin-right:30px;">Amortisasi</label>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-lg-3 col-sm-12">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="inputamortisasibytrans" <?php
              //if($kredit->amortisasi_biaya_transaksi=="1"){echo 'checked';}?>>
            <label class="form-check-label" style="margin-right:30px;">Amortisasi</label>
          </div>
        </div>
      </div>
    ...
    <div class="col-lg-8">
      ...
      <div class="row">
        <div class="col-lg-2 col-sm-12">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="inputditanggungcheck" <?php
              //if($kredit->amortisasi_biaya_transaksi=="1"){echo 'checked';}?>>
