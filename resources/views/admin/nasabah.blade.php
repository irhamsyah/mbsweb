                              ...
                              <div class="tab-content">
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      <div class="col-lg-3 col-sm-6">
                                        ...
                                        <input type="text" name="inputdin" value="{{ $nasabah->NO_DIN }}" readonly class="form-control">
                                      </div>
                                      <div class="col-lg-3 col-sm-6">
                                      ...
                                      <div class="col-lg-2 col-sm-8">
                                        ...
                                        <input type="text" name="inputnasabahid" value="{{ $nasabah->nasabah_id }}" class="form-control">
                                      </div>
                                      ...
                                      <div class="col-lg-2 col-sm-8">
                                        ...
                                        <input type="text" name="inputnocif" value="{{ $nasabah->cif }}" readonly class="form-control">
                                      </div>
                                      <div class="col-lg-1 col-sm-4">
                                        <input type="checkbox" name="inputblacklist" <?php if($nasabah->Black_List === 1) {echo "checked";} ?> class="form-checkbox">
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      <div class="col-lg-3 col-sm-6">
                                        ...
                                        <input type="text" name="inputnamanasabah" value="{{ $nasabah->nama_nasabah }}" id="inputnamanasabah" class="form-control">
                                      </div>
                                      <div class="col-lg-3 col-sm-6">
                                        <label for="inputalias">Alias</label>
                                        <input type="text" name="inputalias" value="{{ $nasabah->nama_alias }}" class="form-control">
                                      </div>
                                      <div class="col-lg-2 col-sm-6">
                                        <label for="inputtempatlahir">Tempat Lahir</label>
                                        <input type="text" name="inputtempatlahir" value="{{ $nasabah->tempatlahir }}" class="form-control">
                                      </div>
                                      <div class="col-lg-2 col-sm-6">
                                        <label for="inputDate1">Tanggal Lahir</label>
                                        <div class="input-group date" id="inputDate3" data-target-input="nearest">
                                            <input type="text" name="inputtgllahir" value="{{ $nasabah->tgllahir }}" class="form-control datetimepicker-input" data-target="#inputDate3"/>
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      <div class="col-lg-3 col-sm-6">
                                        ...
                                        <input type="text" name="inputibukandung" value="{{ $nasabah->IBU_KANDUNG }}" class="form-control">
                                      </div>
                                      <div class="col-lg-3 col-sm-6">
                                        <label for="inputnpwp">NPWP</label>
                                        <input type="text" name="inputnpwp" value="{{ $nasabah->npwp }}" class="form-control">
                                      </div>
                                      <div class="col-lg-2 col-sm-6">
                                      ...
                                      <div class="col-lg-2 col-sm-6">
                                        ...
                                        <input type="text" name="inputnoidentitas" value="{{ $nasabah->no_id }}" class="form-control">
                                      </div>
                                      <div class="col-lg-2 col-sm-6">
                                        <label for="inputDate2">Masa Berlaku</label>
                                        <div class="input-group date" id="inputDate4" data-target-input="nearest">
                                            <input type="text" name="inputmasaberlaku" value="{{ $nasabah->tglid }}" class="form-control datetimepicker-input" data-target="#inputDate4"/>
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      <div class="col-lg-6 col-sm-12">
                                        ...
                                        <input type="text" name="inputdomisili" value="{{ $nasabah->ALAMAT_DOMISILI }}" class="form-control">
                                      </div>
                                      <div class="col-lg-1 col-sm-2">
                                        <label for="inputkodetlp">Kode Telp</label>
                                        <input type="text" name="inputkodetlp" value="{{ $nasabah->kode_area }}" placeholder="031" class="form-control">
                                      </div>
                                      <div class="col-lg-2 col-sm-4">
                                        <label for="inputnotlp">No Telp</label>
                                        <input type="text" name="inputnotlp" value="{{ $nasabah->telpon }}" placeholder="7217201" class="form-control">
                                      </div>
                                      <div class="col-lg-3 col-sm-6">
                                        <label for="inputnohp">No HP</label>
                                        <input type="numtextber" name="inputnohp" value="{{ $nasabah->NO_HP }}" placeholder="081xxxxxxxxx" class="form-control">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="row">
                                      <div class="col-lg-6 col-sm-12">
                                        ...
                                        <input type="text" name="inputalamat" value="{{ $nasabah->alamat }}" class="form-control">
                                      </div>
                                      <div class="col-lg-2 col-sm-12">
                                        <label for="inputkelurahan">Kelurahan</label>
                                        <input type="text" name="inputkelurahan" value="{{ $nasabah->kelurahan }}" class="form-control">
                                      </div>
                                      <div class="col-lg-2 col-sm-12">
                                        <label for="inputkecamatan">Kecamatan</label>
                                        <input type="text" name="inputkecamatan" value="{{ $nasabah->kecamatan }}" class="form-control">
                                      </div>
                                      <div class="col-lg-2 col-sm-12">
                                        <label for="inputkodepos">Kode Pos</label>
                                        <input type="text" name="inputkodepos" value="{{ $nasabah->kode_pos }}" class="form-control">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      <div class="col-lg-3 col-sm-12">
                                        ...
                                        <input type="text" name="inputnamaperusahaan" value="{{ $nasabah->Tempat_Kerja }}" class="form-control">
                                      </div>
                                      <div class="col-lg-9 col-sm-12">
                                        <label for="inputalamatperusahaan">Alamat Perusahaan</label>
                                        <input type="text" name="inputalamatperusahaan" value="{{ $nasabah->alamat_kantor }}" class="form-control">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="row">
                                      ...
                                      <div class="col-lg-3 col-sm-12">
                                        ...
                                        <input type="text" name="inputdetpekerjaan" value="{{ $nasabah->pekerjaan }}" class="form-control">
                                      </div>
                                      <div class="col-lg-3 col-sm-12">
                                      ...
                                      <div class="col-lg-3 col-sm-12">
                                        ...
                                        <input type="number" name="inputpenghasilansetahun" value="{{ $nasabah->penghasilan_setahun }}" class="form-control">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="row">
                                      ...
                                      <div class="col-lg-3 col-sm-12">
                                        ...
                                        <input type="text" name="inputdetgelar" value="{{ $nasabah->KET_GELAR }}" class="form-control">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      <div class="col-lg-3 col-sm-12">
                                        ...
                                        <input type="text" name="inputnamapendamping" value="{{ $nasabah->nama_pendamping }}" class="form-control">
                                      </div>
                                      <div class="col-lg-3 col-sm-12">
                                        <label for="inputidpendamping">ID Pendamping</label>
                                        <input type="text" name="inputidpendamping" value="{{ $nasabah->id_pasangan }}" class="form-control">
                                      </div>
                                      <div class="col-lg-3 col-sm-6">
                                        <label for="inputDate3">Tanggal Lahir Pendamping</label>
                                        <div class="input-group date" id="inputDate6" data-target-input="nearest">
                                            <input type="text" name="inputtgllahirpendamping" value="{{ $nasabah->tgllhr_pasangan }}" class="form-control datetimepicker-input" data-target="#inputDate6"/>
                                      ...
                                      <div class="col-lg-3 col-sm-12">
                                        ...
                                        <input type="number" name="inputjmltanggungan" value="{{ $nasabah->jml_tanggungan }}" placeholder="(Jumlah Orang)" class="form-control">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="row">
                                      <div class="col-lg-3 col-sm-12">
                                        ...
                                        <input type="text" name="inputtujuanbukarek" value="{{ $nasabah->TUJUAN_PEMBUKAAN_KYC }}" class="form-control">
                                      </div>
                                      <div class="col-lg-2 col-sm-12">
                                        <label for="inputpenggunaandana">Penggunaan Dana</label>
                                        <input type="text" name="inputpenggunaandana" value="{{ $nasabah->PENGGUNAAN_DANA_KYC }}" class="form-control">
                                      </div>
                                      <div class="col-lg-2 col-sm-12">
                                        <label for="inputnamaahliwaris">Nama Ahli Waris</label>
                                        <input type="text" name="inputnamaahliwaris" value="{{ $nasabah->NAMA_KUASA }}" class="form-control">
                                      </div>
                                      <div class="col-lg-5 col-sm-12">
                                        <label for="inputalamatahliwaris">Alamat Ahli Waris</label>
                                        <input type="text" name="inputalamatahliwaris" value="{{ $nasabah->ALAMAT_KUASA }}" class="form-control">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="tab-pane" id="specimenedit_{{ md5($nasabah->nasabah_id.'Bast90') }}">
                                  <div class="form-group">
                                    <div class="row">
                                      <div class="col-lg-6 col-sm-12">
                                        <img src="{{ $nasabah->PATH_FOTO }}" style="height:200px;"/>
                                      </div>
                                      <div class="col-lg-6 col-sm-12">
                                        <img src="{{ $nasabah->PATH_TTANGAN }}" style="height:200px;"/>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    <input type="hidden" name="inputIdNasabahHash" class="form-control">
