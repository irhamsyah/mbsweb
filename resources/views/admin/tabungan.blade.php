              ...
              <div class="row form-group">
                ...
                <div class="col-lg-5 col-sm-12">
                  <input type="text" class="form-control" id="idnasabah1" name="norekcari"
                    placeholder="Masukkan No Rek Tabungan">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-3 col-sm-12">
        ...
        <div class="card">
          <div class="card-header">
            <div class="col-lg-3 col-sm-3" style="float:right;">
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-add-tabungan"
                style="float: right;">
                  ...
                  <td>
                    ...
                    <div class="dropdown-menu">
                      <form action="/prof_tab_detail" method="post" style="margin-bottom: 0;">
                        <input type="hidden" name="inputIdTransaction" value="{{ $tabungans->NO_REKENING }}"
                          class="form-control">
                        @csrf
                      </form>
                      <a href="#" class="dropdown-item" data-toggle="modal" data-target="#modal-edit-tabungan"
                        ...
                        data-no_alternatif="{{$tabungans->NO_ALTERNATIF}}" data-cab="{{$tabungans->CAB}}"
                        data-nasabah_id="{{$tabungans->NASABAH_ID}}" data-nama_nasabah="{{$tabungans->nama_nasabah}}"
                        data-alamat="{{$tabungans->alamat}}" data-type_tabungan="{{$tabungans->TYPE_TABUNGAN}}"
                        data-suku_bunga="{{$tabungans->SUKU_BUNGA}}" data-persen_pph="{{$tabungans->PERSEN_PPH}}"
                        data-tgl_bunga="{{$tabungans->TGL_BUNGA}}" {{-- data-blokir="{{$tabungans->BLOKIR}}"
                        ...
                        data-flag_restricted="{{$tabungans->FLAG_RESTRICTED}}" data-minimum="{{$tabungans->MINIMUM}}"
                        data-setoran_minimum="{{$tabungans->SETORAN_MINIMUM}}"
                        data-setoran_per_bln="{{$tabungans->SETORAN_PER_BLN}}" data-abp="{{$tabungans->ABP}}"
              ...
              <div class="row">
                <div class="col-lg-2 col-sm-6">
                  ...
                  <select class="form-control" name="jenis_tabungan" id="editlist">
                    ...
                    <option value="{{ $value->kode_jenis_tabungan}}" data-ebunga="{{$value->SUKU_BUNGA_DEFAULT}}"
                      data-eadm="{{$value->ADM_PER_BLN_DEFAULT}}" data-epph="{{$value->PPH_DEFAULT}}"
                      data-esalmin="{{$value->MINIMUM_DEFAULT}}" data-esetmin="{{$value->SETORAN_MINIMUM_DEFAULT}}"
                      data-esetwajib={{$value->SETORAN_PER_BLN_DEFAULT}} data-erestricted={{$value->FLAG_RESTRICTED}}>{{
                ...
                <div class="col-lg-2 col-sm-6">
                  ...
                  <div class="input-group date" id="inputDate1" data-target-input="nearest">
                    <input type="text" name="tgl_bunga" class="form-control datetimepicker-input"
                      data-target="#inputDate1" />
              ...
              <div class="row">
                <div class="col-lg-2 col-sm-6">
                  ...
                  <select class="form-control" name="jenis_tabungan" id="listItem">
                    <option id="idSelect" selected></option>
                    @foreach($kodejenistabungan as $value)
                    <option value="{{ $value->KODE_JENIS_TABUNGAN}}" data-bunga="{{$value->SUKU_BUNGA_DEFAULT}}"
                      data-adm="{{$value->ADM_PER_BLN_DEFAULT}}" data-pph="{{$value->PPH_DEFAULT}}"
                      data-salmin="{{$value->MINIMUM_DEFAULT}}" data-setmin="{{$value->SETORAN_MINIMUM_DEFAULT}}"
                      data-setwajib={{$value->SETORAN_PER_BLN_DEFAULT}} data-restricted={{$value->FLAG_RESTRICTED}}>{{
                      $value->KODE_JENIS_TABUNGAN}}-{{ $value->DESKRIPSI_JENIS_TABUNGAN}}</option>
                    @endforeach
                  </select>
                </div>
                <div class="col-lg-3 col-sm-6">
