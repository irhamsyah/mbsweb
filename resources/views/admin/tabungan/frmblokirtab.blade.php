...
<div class="content-wrapper" style="margin-top:10px; max-height:800px !important;">
            ...
            <div class="card-body">
              <div class="row form-group">
                <div class="mx-auto col-md-5 col-sm-12">
                  ...
                  <div class="input-group dateYMD" id="inputDate1" data-target-input="nearest">
                    <input type="text" name="inputtglblokir" class="form-control datetimepicker-input" readonly
              ...
              <div class="row form-group">
                <div class="mx-auto col-md-5 col-sm-12">
                  ...
                  <div class="input-group dateYMD" id="inputDate1" data-target-input="nearest">
                    <input type="text" name="no_rekening" id="inputnorekening" class="form-control datetimepicker-input"
                      readonly />
              ...
              <div class="row form-group">
                <div class="mx-auto col-md-5 col-sm-12">
                  ...
                  <div class="input-group dateYMD" id="inputDate1" data-target-input="nearest">
                    <input type="text" name="nama_nasabah" id="inputnamanasabah"
              ...
              <div class="row form-group">
                <div class="mx-auto col-md-5 col-sm-12">
                  ...
                  <div class="input-group dateYMD" id="inputDate1" data-target-input="nearest">
                    <input type="text" name="alamat" id="inputalamat" class="form-control datetimepicker-input"
                      readonly />
                  </div>
                </div>
              </div>
              <div class="row form-group">
                <div class="mx-auto col-md-5 col-sm-12">
                  ...
                  <div class="input-group dateYMD" id="inputDate1" data-target-input="nearest">
                    <input type="text" name="jenis_tabungan" id="inputjenistabungan"
                      class="form-control datetimepicker-input" readonly />
                  </div>
                </div>
              </div>
              <div class="row form-group">
                <div class="mx-auto col-md-5 col-sm-12">
                  ...
                  <div class="input-group dateYMD" id="inputDate1" data-target-input="nearest">
                    <input type="text" name="saldo_akhir" id="inputsaldoakhir" class="form-control datetimepicker-input"
                      readonly />
                  </div>
                </div>
              </div>
              <div class="row form-group">
                <div class="mx-auto col-md-5 col-sm-12">
                  ...
                  <div class="input-group dateYMD" id="inputDate1" data-target-input="nearest">
                    <input type="text" name="saldo_blokir" id="inputsaldoblokir"
                      class="form-control datetimepicker-input" readonly />
                  </div>
                </div>
              </div>
              <div class="row form-group">
                <div class="mx-auto col-md-5 col-sm-12">
                  ...
                  <div class="input-group dateYMD" id="inputDate1" data-target-input="nearest">
                    <input type="text" name="jml_blokir" id="inputjmltransaksi"
  ...
  <div class="modal fade bs-modal-nas" id="ambildatataabungan" tabindex="-1" role="dialog"
