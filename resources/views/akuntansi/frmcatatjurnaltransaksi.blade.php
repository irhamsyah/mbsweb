    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="card card-warning card-outline">
          <!-- form start -->
          <form method="POST" action="/bo_tb_de_savetempjurnalmemorial" role="search">
            @csrf
            <div class="card-body">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="input-group date" data-target-input="nearest">
                              <input id="idKodePerkadd" type="text" name="kode_perk" readonly class="form-control" required>
                                ...
                                <input type="text" name="nama_perk" id="idNamaPerkadd" class="form-control" readonly style="width: 400px;border : 0px;background-color:rgb(249, 249, 250)">
                        </div>
              ...
              <div class="row form-group">
                <div class="col-4" style="margin-left:450px">
                  <button type="submit" class="btn-lg btn-success"><i class="fa fa-check" style="color:white">Create</i></button>
                </div>
              </div>
            </div>
            <!-- /.card-body -->
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <div class="dropdown-menu">
                                ...
                                <form method="post" action="/bo_ak_tt_delcatatjurnaldetail" style="margin-bottom: 0;" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')">
        ...
        <div class="card">
          ...
          <form method="POST" action="/bo_ak_tt_simpancatatjurnal">
            ...
            <div class="row form-group">
              <div class="col-4" style="margin-left:450px">
                <button type="submit" class="btn-lg btn-danger"><i class="fa fa-check" style="color:white">Simpan Jurnal</i></button>
              </div>
            </div>
          </form>
