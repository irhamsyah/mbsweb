...
<div class="content-wrapper" style="margin-top:10px; max-height:800px !important;">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="col-lg-3 col-sm-3" style="float:right;">
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-add-kodeperk"
                style="float: right;">
                  ...
                  <td>
                    ...
                    <div class="dropdown-menu">
                      <a href="" tabindex="-1" class="dropdown-item" data-toggle="modal"
                        ...
                        data-kode_perk="{{$values->kode_perk}}" @if(is_null($values->perkiraan))
                        data-nama_perk=""
                        @else
                      ...
                      <form method="post" action="/bo_ak_tt_deltransdetailbuff" style="margin-bottom: 0;"
          ...
          <form method="POST" action="/bo_ak_tt_simpanjurnal">
            ...
            <div class="form-group">
              <a href="{{route('showformvalidasidatatransaksi')}}" class="btn btn-primary btn-mdm" tabindex="-1"
                role="button">Back</a>
  ...
  <div class="modal fade" id="modal-add-kodeperk" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
  ...
  <div class="modal fade bs-modal-nas" id="ambildataperkiraan" tabindex="-1" role="dialog"
