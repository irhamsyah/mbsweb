...
<html lang="en">
  ...
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
    ...
    <div class="container">
      ...
      <a href="{{route('frmlabarugikonsol')}}" class="btn btn-md btn-normal">
      ...
      <a href="{{route('exportlabarugikonsol1',['tgl_trans'=>$tgl_trans])}}">
        <i class='fas fa-file-export'>Export</i>
      </a>
        <h4>LABA RUGI KONSOLIDASI</h4>
