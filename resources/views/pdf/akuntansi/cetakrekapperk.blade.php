...
<html lang="en">
    <head>
        ...
        <title>Rekapitulasi Perkiraan</title>
      </head>
      <body>
    <div class="container">
      ...
      <a href="{{route('showfrmrekapperk')}}" class="btn btn-md btn-normal">
          ...
          <table id="tbl1" class="table table-responsive" style="border-style:none">
            ...
            @endforeach
                <tr>
                    <td>Total Jumlah</td>
                    <td></td>
                    <td>{{number_format($totsaldoawal,2,".",",")}}</td>
                    <td>{{number_format($totdebet,2,".",",")}}</td>
                    <td>{{number_format($totkredit,2,".",",")}}</td>
                    <td>{{number_format($totsaldoakhir,2,".",",")}}</td>
                </tr>
            </tbody>
        </table>
