...
<html lang="en">
    ...
    <style>
      ...
      br{
        ...
        <title>Daftar Nominatif Tabungan Pasif</title>
      </head>
      <body>
    <div class="container">
      ...
      <a href="{{route('bo_tb_rpt_nominatifpasif')}}" class="btn btn-md btn-normal">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="blackColor" class="bi bi-house-check" viewBox="0 0 16 16">
