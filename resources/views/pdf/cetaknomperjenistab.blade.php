...
<html lang="en">
    ...
    {{-- <style>
      ...
      br{
        ...
        <title>Daftar Nominatif Per Jenis Tabungan</title>
      </head>
      <body>
    <div class="container">
      ...
      <a href="{{route('nominatifperjenistab')}}" class="btn btn-md btn-normal">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-check" viewBox="0 0 16 16">
          ...
          <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm1.679-4.493-1.335 2.226a.75.75 0 0 1-1.174.144l-.774-.773a.5.5 0 0 1 .708-.707l.547.547 1.17-1.951a.5.5 0 1 1 .858.514Z"/>
            ...
            <br>{{$lembaga->Value}}<br>
            @endforeach
            <h6>Daftar Nominatif Tabungan Jenis Tabungan : {{$desc}}</h6>
          ...
          <table id="tbl1" class="table table-bordered table-responsive">
            ...
            <tr>
                ...
                <th rowspan="2">Saldo per {{$tgl_nom}}</th>
