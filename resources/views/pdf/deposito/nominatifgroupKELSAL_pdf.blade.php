...
<body> 
    ...
    <table id="tbl1" class="table table-bordered">
        ...
        @foreach($nominatif as $index => $values)
            @php(++$n)
            @if($index == 0)
                @php(array_push($jenisdep,$values->NOMINAL))
                @if($jenisdep[0]>0 && $jenisdep[0]<=2500000)
                <tr>
                    <td></td>
                    <td><h5>{{'0 S/D 2.500.000'}}</h5></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                @elseif($jenisdep[0]>=2500000 && $jenisdep[0]<=5000000)
                <tr>
                    <td></td>
                    <td><h5>{{'0 S/D 2.500.000'}}</h5></td>
                    <td></td>
            ...
            @elseif($index > 0)
                @php(array_push($jenisdep,$values->NOMINAL))
                @if($jenisdep[$index] > 2500000 && $jenisdep[$index]<=5000000 && $jenisdep[$index-1]<=2500000)
                    ...
                    <tr>
                        <td></td>
                        <td><h5>{{'2.500.000 S/D 5000.000'}}</h5></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                ...
                @elseif($jenisdep[$index] > 5000000 && $jenisdep[$index]<=10000000 && $jenisdep[$index-1]<=5000000)
                <tr style="border: solid 1px">
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td></td>
                    <td><h5>{{'5000.000 S/D 10.000.000'}}</h5></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                @elseif($jenisdep[$index] > 10000000 && $jenisdep[$index]<=20000000 && $jenisdep[$index-1]<=10000000)
                <tr style="border: solid 1px">
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td></td>
                    <td><h5>{{'10.000.000 S/D 20.000.000'}}</h5></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                @elseif($jenisdep[$index] > 20000000 && $jenisdep[$index-1]<=20000000)
                @php($cetak=0)
