...
<body>
    <div class="container">
        ...
        <a href="{{route('realisasikredit')}}" class="btn btn-md btn-normal">
        ...
        <div class="container" style="margin-left: 150px;font-size:12pt">
            ...
            <div class="row" style="padding: 0px;margin-bottom: -8px;">
                {{$provisi}} &nbsp; {{$notariel}}&nbsp;{{$premi}}&nbsp;{{$administrasi}}&nbsp;{{$materai}}&nbsp;{{$lain2}}&nbsp;{{$pokok_materai}}&nbsp;{{$biaya_transaksi}}&nbsp;{{$premi_kendaraan}}
            </div>
            <div class="row" style="padding: 0px;margin-bottom: -8px;">
                {{$total_diterima}}
            </div>
            <div class="row" style="padding: 0px;margin-bottom: -8px;">
                {{$rekening_overbook}}{{$nama_nasabah}}
            </div>
