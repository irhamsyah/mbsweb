...
<div class="content-wrapper" style="margin-top:10px; max-height:800px !important;">
  <div class="container-fluid">
    <h5>Schedule Pembayaran Deposito</h5>
    <div class="row">
      <div class="col-12">
        <div class="card card-warning card-outline">
          <!-- form start -->
          <form method="POST" action="bo_dp_rp_frmjadwaldeposito" role="search">
            @csrf
            <div class="card-body">
                ...
                <div class="mx-auto col-md-3 col-sm-12">
                  ...
                  <div class="input-group date" id="idtglnominatif2" data-target-input="nearest">
                    <input type="text" name="tgl_trans2" class="form-control datetimepicker-input"
                      value="<?php if(isset($tgltrs2)){echo($tgltrs2);} ?>" data-target="#idtglnominatif2" />
          ...
          @if(isset($transaksi))
          <form method="POST" action="exportjadwalbyrbng" role="search" style="margin-top:-40px;margin-left:180px">
            @csrf
            ...
            <div class="row form-group">
              <div class="mx-auto col-md-5 col-sm-12">
                ...
                <a href="{{ route('cetakjadwalbunga',['tgl_trans1'=>$tgltrs1,'tgl_trans2'=>$tgltrs2])}}"
