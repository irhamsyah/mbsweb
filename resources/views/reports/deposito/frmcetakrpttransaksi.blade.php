    ...
    <div class="row">
      <div class="col-12">
        <div class="card card-warning card-outline">
          ...
          @if(isset($transaksi))
          <form method="POST" action="exporttoexceltransaksidep" role="search"
            style="margin-top:-40px;margin-left:180px">
            @csrf
            ...
            <div class="row form-group">
              <div class="mx-auto col-md-5 col-sm-12">
                ...
                <a href="{{ route('cetaktransaksideposito',['tgl_trans1'=>$tgltrs1,'tgl_trans2'=>$tgltrs2])}}"
