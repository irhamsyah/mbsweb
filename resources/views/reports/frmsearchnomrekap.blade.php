    ...
    <div class="row">
      <div class="col-12">
        <div class="card card-warning card-outline">
          <!-- form start -->
          <form method="POST" action="/bo_tb_rpt_nominatifrekapview" role="search">
          @csrf
            <div class="card-body">
              <div class="row form-group">
                <div class="mx-auto col-md-3 col-sm-12">
                    <label for="inputDate1">Rekap per Tanggal</label>
                    <div class="input-group date" id="inputDate1" data-target-input="nearest">
                      <input type="text" name="tgl_nominatif" class="form-control datetimepicker-input" data-target="#inputDate1"/>
                ...
                <div class="row form-group">
                    <div class="mx-auto col-md-3 col-sm-12">
                        <label for="inputidentitas">Rekap berdasarkan</label>
