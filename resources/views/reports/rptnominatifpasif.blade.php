...
<div class="content-wrapper" style="margin-top:10px; max-height:800px !important;">
  ...
  <div class="container-fluid">
    <h5>Nominatif Tabungan Pasif</h5>
    <div class="row">
      <div class="col-12">
        <div class="card card-warning card-outline">
          <!-- form start -->
          <form method="GET" action="/bo_tb_rpt_nominatifpasif" role="search">
          @csrf
            <div class="card-body">
          ...
          <form method="POST" action="nominatifpasifeksport" role="search">
            @csrf
          <div class="row form-group">
            ...
            <div class="mx-auto col-md-6 col-sm-12">
              ...
              <a href="{{ route('cetaknomtabunganpasif',['tgl_nominatif'=>$inputantgl])}}" class="btn btn-md btn-danger"> Cetak Nominatif</a>
            </div>
          </div>
        </form>
        </div>
