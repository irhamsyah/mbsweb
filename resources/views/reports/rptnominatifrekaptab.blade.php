    ...
    <div class="row">
      <div class="col-12">
        <div class="card card-warning card-outline">
          <!-- form start -->
          <form method="GET" action="/bo_tb_rpt_nominatifrekap" role="search">
          @csrf
            <div class="card-body">
          ...
          <form method="POST" action="nominatifrekapeksport/{{$inputantgl}}" role="search">
            @csrf
          <div class="row form-group">
            ...
            <div class="mx-auto col-md-5 col-sm-12">
              ...
              <a href="{{ route('cetaknomtabunganrekap',['tgl_nominatif'=>$inputantgl,'rekap'=>$rekap])}}" class="btn btn-md btn-danger"> Cetak Nominatif</a>
            </div>
          </div>
        </form>
        </div>
            ...
            <table id="example1" class="display" width="100%">
              ...
              <tbody>
                  @foreach(array_chunk($nominatif,1) as $values)
                    ...
                    <tr>
                      <td>{{$nominatifs->kode}}</td>
                      <td>{{$nominatifs->deskripsi}}</td>
