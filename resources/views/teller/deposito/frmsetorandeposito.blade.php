              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-lg-2 col-sm-6">
                    ...
                    <input type="text" name="jumlah_setoran" class="form-control" id="putjumlahsetoran" readonly
                      required>
                  </div>
                  <div class="col-lg-2 col-sm-6">
                    <label for="inputDate4">Tgl Transaksi</label>
                    <div class="input-group date" id="inputDate4" data-target-input="nearest">
                      <input type="text" name="tgl_transaksi" class="form-control datetimepicker-input"
                        data-target="#inputDate4" value="{{ $tgllogin }}" readonly />
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <button type="submit" class="btn btn-primary" style="float:right;margin-top:15px"><i
                        class="fa fa-check" aria-hidden="true"></i> Simpan & Cetak</button>
                  </div>
                </div>
              </div>
            </div>
