...
<div class="content-wrapper" style="margin-top:10px; max-height:800px !important;">
                ...
                <div class="col-lg-2 col-sm-8">
                  ...
                  <div class="input-group dateYMD" id="inputDate1" data-target-input="nearest">
                    <input type="text" name="tgl_trans" class="form-control datetimepicker-input" readonly
                      value="{{date('Y-m-d',strtotime($tglharini))}}" />
                  </div>
                </div>
              </div>
              <div class="form-group">
                  ...
                  <div class="col-lg-2 col-sm-8">
                    ...
                    <select class="form-control" name="kode_trans" id="putkodetrans">
                      ...
                      @while ($i<count($kodetranstab) ) <option
                        value="{{$kodetranstab[$i]->KODE_TRANS}}-{{$kodetranstab[$i]->TOB}}-{{$kodetranstab[$i]->TYPE_TRANS}}-{{$kodetranstab[$i]->DESKRIPSI_TRANS}}">
  ...
  <div class="modal fade bs-modal-nas" id="ambildatatabungan" tabindex="-1" role="dialog"
